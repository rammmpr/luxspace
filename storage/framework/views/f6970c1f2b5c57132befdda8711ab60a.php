<!-- START: HEADER -->
<header class="<?php echo e(\Route::current()->getName() == 'index' ? 'absolute' : ''); ?> w-full z-50 px-4">
    <div class="container mx-auto py-5">
        <div class="flex flex-stretch items-center">
            <div class="w-56 items-center flex">
                <a href="<?php echo e(route('index')); ?>">
                    <img src="<?php echo e(url('/frontend/images/content/logo.png')); ?>"
            ...
            <div class="w-auto">
                <ul class="fixed bg-white inset-0 flex flex-col invisible items-center justify-center opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center"
                    ...
                    <li class="mx-3 py-6 md:py-0">
                        <a href="#"
                            class="text-black <?php echo e(\Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black'); ?> hover:underline">Showcase</a>
                    </li>
                    <li class="mx-3 py-6 md:py-0">
                        <a href="#"
                            class="text-black <?php echo e(\Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black'); ?> hover:underline">Catalog</a>
                    </li>
                    <li class="mx-3 py-6 md:py-0">
                        <a href="#"
                            class="text-black <?php echo e(\Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black'); ?> hover:underline">Delivery</a>
                    </li>
                    <li class="mx-3 py-6 md:py-0">
                        <a href="#"
                            class="text-black <?php echo e(\Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black'); ?> hover:underline">Rewards</a>
                    </li>
                    <?php if(auth()->guard()->check()): ?>
                        <li class="mx-3 py-6 md:py-0">
                            <a href="<?php echo e(route('dashboard.index')); ?>"
                                class="text-black <?php echo e(\Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black'); ?> hover:underline">Dashboard</a>
                        </li>
                    <?php endif; ?>
                    <?php if(auth()->guard()->guest()): ?>
                        <li class="mx-3 py-6 md:py-0">
                            <a href="<?php echo e(route('login')); ?>"
                                class="text-black <?php echo e(\Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black'); ?> hover:underline">Login</a>
                        </li>
                        <li class="mx-3 py-6 md:py-0">
                            <a href="<?php echo e(route('register')); ?>"
                                class="text-black <?php echo e(\Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black'); ?> hover:underline">Register</a>
                        </li>
                    <?php endif; ?>
                </ul>
            </div>
                ...
                <ul class="items-center flex">
                    <li class="ml-6 block md:hidden">
                        <button id="menu-toggler"
                            class="relative flex z-50 items-center justify-center w-8 h-8 text-black <?php echo e(\Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black'); ?> focus:outline-none">
                    ...
                    <li class="ml-6">
                        <a id="header-cart"
                            class="flex items-center justify-center w-8 h-8 text-black <?php echo e(\Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black'); ?>"
...
<!-- END: HEADER -->
<?php /**PATH /home/rammkanaeru/laravel/youtube-ustadz/luxspace/resources/views/components/frontend/navbar.blade.php ENDPATH**/ ?>