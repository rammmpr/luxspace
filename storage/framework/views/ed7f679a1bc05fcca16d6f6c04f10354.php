            ...
            <div class="flex -mx-4 flex-row relative">
                ...
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="px-4 relative card group">
                        ...
                        <span class="">IDR <?php echo e(number_format($product->price)); ?></span>
                        <a href="<?php echo e(route('details', $product->slug)); ?>" class="stretched-link">
                            <!-- fake children -->
                        </a>
                    </div>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rammkanaeru/laravel/youtube-ustadz/luxspace/resources/views/pages/frontend/index.blade.php ENDPATH**/ ?>