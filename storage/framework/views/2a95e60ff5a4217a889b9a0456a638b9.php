    ...
    <section class="container mx-auto">
        <div class="flex flex-wrap my-4 md:my-12">
            <div class="w-full md:hidden px-4">
                <h2 class="text-5xl font-semibold"><?php echo e($product->name); ?></h2>
                <span class="text-xl">IDR <?php echo e(number_format($product->price)); ?></span>
            </div>
            <div class="flex-1">
                <div class="slider">
                    <div class="thumbnail">
                        <?php $__currentLoopData = $product->galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="px-2">
                                <div class="item <?php echo e($loop->first ? 'selected' : ''); ?>"
                                    data-img="<?php echo e(Storage::url($item->url)); ?>">
                                    <img src="<?php echo e(Storage::url($item->url)); ?>" alt="front"
                    ...
                    <div class="preview">
                        <div class="item rounded-lg h-full overflow-hidden">
                            <img src="<?php echo e($product->galleries()->exists() ? Storage::url($product->galleries->first()->url) : 'data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=='); ?>"
            ...
            <div class="flex-1 px-4 md:p-6">
                <h2 class="text-5xl font-semibold"><?php echo e($product->name); ?></h2>
                <p class="text-xl">IDR <?php echo e(number_format($product->price)); ?></p>
                    ...
                    <div class="px-3 flex-none" style="width: 320px">
                        <div class="rounded-xl p-4 pb-8 relative bg-white">
                            <div class="rounded-xl overflow-hidden card-shadow w-full h-36">
                                <img src="<?php echo e($recommendation->galleries()->exists() ? Storage::url($recommendation->galleries->first()->url) : 'data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=='); ?>"
                                    alt="" class="w-full h-full object-cover object-center" />
                            </div>
                            <h5 class="text-lg font-semibold mt-4"><?php echo e($recommendation->name); ?></h5>
                            <span class="">IDR
                                <?php echo e(str_replace(',', '.', number_format($recommendation->price))); ?></span>
                            <a href="<?php echo e(route('details', $recommendation->slug)); ?>" class="stretched-link">
                                <!-- fake children -->
                            </a>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rammkanaeru/laravel/youtube-ustadz/luxspace/resources/views/pages/frontend/details.blade.php ENDPATH**/ ?>