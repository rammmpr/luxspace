                ...
                <div class="w-full px-4 mb-4 md:w-8/12 md:mb-0" id="shopping-cart">
                        ...
                        <div class="flex flex-start flex-wrap items-center mb-4 -mx-4" data-row="1">
                            <div class="px-4 flex-none">
                                <div class="" style="width: 90px; height: 90px">
                                    <img src="<?php echo e($item->product->galleries()->exists() ? Storage::url($item->product->galleries->first()->url) : 'data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=='); ?>"
                            ...
                            <div class="px-4 w-auto flex-1 md:w-5/12">
                                <div class="">
                                    ...
                                    <h6 class="font-semibold text-base md:text-lg block md:hidden">
                                        IDR <?php echo e(str_replace(',', '.', number_format($item->product->price))); ?>
                            ...
                            <div class="px-4 w-auto flex-none md:flex-1 md:w-5/12 hidden md:block">
                                <div class="">
                                    <h6 class="font-semibold text-lg">IDR
                                        <?php echo e(str_replace(',', '.', number_format($item->product->price))); ?></h6>
                                </div>
                            </div>
                            <div class="px-4 w-2/12">
                                <div class="text-center">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <p id="cart-empty" class="hidden text-center py-8">
                            Ooops... Cart is empty
                            <a href="<?php echo e(route('index')); ?>" class="underline">Shop Now</a>
                        </p>
                    <?php endif; ?>
                    <!-- END: ROW 1 -->
                </div>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rammkanaeru/laravel/youtube-ustadz/luxspace/resources/views/pages/frontend/cart.blade.php ENDPATH**/ ?>